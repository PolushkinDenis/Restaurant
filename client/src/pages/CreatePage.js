    ...
    <div className="row">
      ...
      <div>
        <div class="container1">
          ...
          <div class="about__descr">
            ...
            <p>
              <b>Формат</b>
              <p>  В ресторанах London действует меню и карта бара, где все цены равны себестоимости. Для того, чтобы воспользоваться
              данным предложением вам необходимо приобрести браслет.
      ...
      <div>
        ...
        <div className="foGrid">
          <div className="info">
            <p>
              Мне действительно важно, чтобы каждый ваш визит в наши Рестораны честных цен приносил только самые приятные эмоции! Поделитесь,
